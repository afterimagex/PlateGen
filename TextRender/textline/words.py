...
class Word(object):
    ...
    def get_chinese_words(cls):
        f = codecs.open(os.path.join(resource_dir, 'words', 'chinese_word.txt'),
                        mode='r', encoding='utf-8')
        # f = codecs.open(os.path.join(resource_dir, 'words', 'char_std_5990.txt'),
        #                 mode='r', encoding='utf-8')
        lines = f.readlines()
        f.close()
    ...
    def get_all_words(self):
        ...
        return words
        # f = codecs.open(os.path.join(resource_dir, 'words', 'all_words.txt'),
        #                 mode='r', encoding='utf-8')
        # lines = f.readlines()
        # f.close()
        # lines = [l.strip() for l in lines]
